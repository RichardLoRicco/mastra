...
Mastra also supports AI SDK v5 see the following section for v5 specific methods: [Vercel AI SDK v5](/docs/deployment/frameworks/agentic-uis/ai-sdk#vercel-ai-sdk-v5)
