...
This guide covers deploying integrated Mastra applications. Mastra can be integrated with a variety of web frameworks, see 
one of the following for a detailed guide.

- [With Next.js](/docs/deployment/frameworks/web-frameworks/next-js)
- [With Astro](/docs/deployment/frameworks/web-frameworks/astro)
...
If you've integrated Mastra with Next.js [by following our guide](/docs/deployment/frameworks/web-frameworks/next-js) and plan to deploy to Vercel, no additional setup is required.
...
If you've integrated Mastra with Astro [by following our guide](/docs/deployment/frameworks/web-frameworks/astro) and plan to deploy to Vercel, no additional setup is required.
